...
def test_generic_sampler():
    ...
    with pytest.raises(KeyError):
        blockies.Sampler._sample('ronny', test_dict)
...
def test_samplers_valid():
    ...
    samplers = [
        blockies.Sampler(),
        blockies.ColorBiasedSampler(),
        blockies.HighVariationSampler(),
        blockies.HighVariationColorBiasedSampler()
    ]
...
def test_resampeling():
    ...
    sampler = blockies.ColorBiasedSampler()
